...
export const es = {
  ...
  products: {
    ...
    currentTotal: "Total historico",
    reviewQuantity: "En revisión",
    otherQuantity: "Otros",
  ...
  customers: {
    ...
    searchPlaceholder: "Buscar por nombre, referencia, teléfono o correo...",
  ...
  transactions: {
    ...
    onlyUpsProductsNote:
      'Solo se muestran productos con número de UPS asignado. Para artículos sin UPS usa "Agregar UPS 0".',
    addUnregisteredLineButton: "Agregar UPS 0",
    addUnregisteredModalTitle: "Agregar producto sin registrar (UPS 0)",
    unregisteredNameLabel: "Nombre del producto",
    unregisteredNamePlaceholder: "Ej: Producto de mostrador",
    unregisteredPriceLabel: "Precio unitario",
    unregisteredCategoryLabel: "Categoría (opcional)",
    unregisteredNoCategory: "Sin categoría",
    unregisteredBrandPlaceholder: "Ej: Marca opcional",
    addUnregisteredConfirm: "Agregar al detalle",
    ...
    autoSettlementNotice: "Ajuste automático para mantenerla liquidada:",
    ...
    pendingSyncSuffix:
      "cambio(s) pendiente(s) de sincronizar antes de modificar.",
    failedSyncSuffix:
      "operacion(es) fallida(s). Reintenta sincronizar antes de modificar.",
  },
  ...
  errors: {
    ...
    transactionUndoNotFound: "La transacción ya no existe o ya fue deshecha.",
  ...
  confirm: {
    ...
    restore:
      "¿Está seguro que desea restaurar el respaldo? Esto reemplazará todos los datos actuales.",
  },
};
