...
export const useProductStore = create<ProductStore>()(
  persist(
    ...
    }),
    {
      ...
      partialize: (state) => ({
        products: state.products.slice(-PERSIST_PRODUCT_LIMIT),
      ...
      onRehydrateStorage: () => (state) => {
        if (state) {
          ...
          if (state.products.length > PERSIST_PRODUCT_LIMIT) {
            state.products = state.products.slice(-PERSIST_PRODUCT_LIMIT);
          }
