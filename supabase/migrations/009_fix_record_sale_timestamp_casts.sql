-- Fix record_sale RPC timestamp casting for timestamptz columns.
-- Without explicit casts, inserts can fail with:
-- "column ""date"" is of type timestamp with time zone but expression is of type text"
